...
const post5: Post = {
  ...
  image: "/src/data/posts/images/ReactNativeGuia.jpg", 
  ...
  content: `
    ...
    <img src="/src/data/posts/images/ComponentesAppMobil.jpg" alt="Conceptos básicos de React Native" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/ExpoGo.jpg" alt="Crear una aplicación básica con Expo Go" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/TerminalPC.png" alt="Terminal de comandos" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/PruebaReactNative.jpg" alt="Modificar App" class="post-image w-68 h-auto object-contain" />
    <h2 class="post-subtitle">Componentes y estilos en React Native</h2>
    <img src="/src/data/posts/images/EstilosReactNative.jpg" alt="Componentes y estilos" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/BotonReactNative.jpg" alt="Componente Boton" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/Ejemplousestate.jpg" alt="Manejo del estado y eventos" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/APIyBD.jpg" alt="Integración con APIs y bases de datos" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/OptimizacionReactNative.jpg" alt="Optimización del rendimiento" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/VariedadPantallas.jpg" alt="Diseño responsivo" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/useContextRN.png" alt="Gestión de estado compartido" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/IntegracionRN1.png" alt="Integración de plataformas externas" class="post-image w-68 h-auto object-contain" />
    <img src="/src/data/posts/images/IntegracionRN2.png" alt="Integración de plataformas externas" class="post-image w-68 h-auto object-contain" />
    <img src="/src/data/posts/images/IntegracionRN3.png" alt="Integración de plataformas externas" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/PruebasRN.jpg" alt="Pruebas y depuración" class="post-image w-68 h-auto object-contain" />
    ...
    <img src="/src/data/posts/images/PublicaDistribuye.png" alt="Publicación y distribución" class="post-image w-68 h-auto object-contain" />
