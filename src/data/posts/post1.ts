...
const post1: Post = {
  ...
  content: `
    ...
    <img src="/src/data/posts/images/specialization.jpg" alt="Specialization in Programming" class="post-image" />
    ...
    <img src="/src/data/posts/images/capabilities.jpg" alt="Capabilities of Your PC" class="post-image" />
    ...
    <img src="/src/data/posts/images/internet-speed.jpg" alt="Internet Speed" class="post-image" />
    ...
    <img src="/src/data/posts/images/choice-area.png" alt="Choice of Area and Necessary Resources" class="post-image" />
    ...
    <img src="/src/data/posts/images/documentation.jpg" alt="Documentation and Continuous Training" class="post-image" />
    ...
    <img src="/src/data/posts/images/patience.jpg" alt="Patience and Discipline" class="post-image" />
